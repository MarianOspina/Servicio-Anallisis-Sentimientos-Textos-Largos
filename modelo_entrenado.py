# -*- coding: utf-8 -*-
"""Modelo Entrenado.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1pRDLTCLuKZADZRkFAENToEeLrNktn7gz
"""
...
texto = input("Por favor, escribe tu texto: ")

# Analizar el sentimiento del texto proporcionado por el usuario
sentimiento_promedio_descriptivo, estrellas, confianza_promedio = analizar_sentimiento_hf(texto)
print("El sentimiento promedio del texto es:", sentimiento_promedio_descriptivo)
print("Número de estrellas:", estrellas)
print("Porcentaje de confianza:", confianza_promedio * 100, "%")